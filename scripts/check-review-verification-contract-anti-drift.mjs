...
requireAll(SWARM_SKILL_FILE, read(SWARM_SKILL_FILE), [
  ...
  ['generalizes the reference-reproduction special case', 'special\ncase where a published number anchors the check'],
  ['blinded-input requirement', 'only the problem statement and the raw\ninputs'],
  ['no answer-bearing input', "never the claimant's answer, evidence selection, or initial judgment"],
