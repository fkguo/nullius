...
export const FRONT_DOOR_SNIPPETS = [
  ...
  },
  {
    ...
    snippets: [
      ...
      'The current idea-engine phase is closed; do not treat it as a default capability-expansion lane.',
      'post-search rank/promote and bounded negative failure-library reflection remain `idea-engine` runtime-contract truth, not a root front door',
  ...
  },
  {
    ...
    snippets: [
      ...
      '当前 idea-engine phase 已关闭，不应把它当作默认 capability expansion lane。',
      'post-search rank/promote 与 bounded negative failure-library reflection 属于 `idea-engine` runtime-contract truth，不是 root front door',
  ...
  },
  {
    ...
    snippets: [
      ...
      'the current idea-engine phase is closed; `@nullius/idea-mcp` remains campaign/search/eval oriented on explicit external data roots',
      'bounded negative failure-library reflection inside the runtime contract, not as a root front door or a new default capability lane',
  ...
  },
  {
    ...
    snippets: [
      ...
      'the current idea-engine phase is closed rather than a default capability-expansion lane',
      'post-search `rank.compute` / `node.promote` and bounded negative failure-library reflection stay inside the `idea-engine` runtime contract',
      'important literature notes require full-text/source-first reading, auditable section/page/equation/figure coverage, and LaTeX math notation',
