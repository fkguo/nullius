...
export const FRONT_DOOR_SNIPPETS = [
  ...
  },
  {
    ...
    snippets: [
      ...
      'posterior-based rank/promote, node posterior/lifecycle/grounding-audit updates, provenance correction, and generation-pack import (`node.import_generated`) remain `idea-engine` runtime-contract truth, not a root front door',
  ...
  },
  {
    ...
    snippets: [
      ...
      'posterior 排序的 rank/promote、节点 posterior/lifecycle/grounding-audit 更新、溯源修正与 generation-pack 导入（`node.import_generated`）属于 `idea-engine` runtime-contract truth，不是 root front door',
