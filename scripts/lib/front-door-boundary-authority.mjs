...
export const FRONT_DOOR_SNIPPETS = [
  ...
  },
  {
    ...
    snippets: [
      ...
      'posterior-based rank/promote, node posterior/lifecycle updates, and generation-pack import (`node.import_generated`) remain `idea-engine` runtime-contract truth, not a root front door',
  ...
  },
  {
    ...
    snippets: [
      ...
      'posterior 排序的 rank/promote、节点 posterior/lifecycle 更新与 generation-pack 导入（`node.import_generated`）属于 `idea-engine` runtime-contract truth，不是 root front door',
