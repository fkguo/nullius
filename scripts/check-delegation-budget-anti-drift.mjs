...
requireAll(GATE_FILE, read(GATE_FILE), [
  ...
  ['discrete-attempts measurement rule', 'attempt counts are discrete'],
...
requireAll(TESTS_FILE, testsText, [
  ...
  ['retry-of fractional-attempts control', 'test_retry_of_attempts_fractional_measured_fails'],
  ['decimal-boundary digit-count control', 'test_decimal_str_exact_digit_count_at_boundary'],
