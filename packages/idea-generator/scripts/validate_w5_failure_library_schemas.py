#!/usr/bin/env python3
"""Validate W5-02 failure-library schemas and bundled example artifacts."""
...
def main() -> int:
    ...
    example_root = repo_root / "docs/plans/examples/2026-02-15-w5-02-failure-library"
    ...
    if errors:
        print("ERROR: W5-02 failure library schema validation failed", file=sys.stderr)
        for err in errors:
            print(f" - {err}", file=sys.stderr)
        return 1

    print("OK: W5-02 failure library schemas and examples validated")
    return 0
