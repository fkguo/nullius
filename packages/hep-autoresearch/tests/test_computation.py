...
class TestComputation(unittest.TestCase):
    def test_computation_minimal_single_phase(self) -> None:
        import sys

        sys.path.insert(0, str(_src_root()))
        from hep_autoresearch.toolkit.computation import ComputationInputs, computation_one
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            out = repo_root / "artifacts" / "runs" / "M1-test-computation" / "computation"
    ...
    def test_computation_report_renders_headline_numbers_and_acceptance_checks(self) -> None:
        import sys
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            res = computation_one(
                ComputationInputs(
                    tag="M1-test-computation-report",
                    project_dir=str(project_dir),
                    run_card=str(run_card_path),
                    trust_project=True,
                    resume=False,
            ...
            out = repo_root / "artifacts" / "runs" / "M1-test-computation-report" / "computation"
    ...
    def test_computation_resume_crash_recovery_running_to_failed(self) -> None:
        import sys
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            out = repo_root / "artifacts" / "runs" / "M2-test-computation" / "computation"
            out.mkdir(parents=True, exist_ok=True)
            phase_state = {
                "schema_version": 1,
                "created_at": "2026-02-08T00:00:00Z",
                "updated_at": "2026-02-08T00:00:00Z",
                "run_id": "M2-test-computation",
                "workflow_id": "computation",
                "project_dir": str(project_dir),
    ...
    def test_computation_cycle_detection_raises(self) -> None:
        import sys
    ...
    def test_computation_on_failure_continue_runs_independent_phase(self) -> None:
        import sys
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            out = repo_root / "artifacts" / "runs" / "M4-test-computation" / "computation"
