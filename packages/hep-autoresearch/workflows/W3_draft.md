# W3a — Draft writing (Draft_Derivation/KB → compilable draft)

Chinese version: `workflows/W3_draft.zh.md`.

## Goal

Before entering `W3_revision` (review → revise → re-review), produce a **compilable paper draft** from an existing `Draft_Derivation.md` + `knowledge_base/` (and optionally `artifacts/`), in a reproducible and auditable way.
