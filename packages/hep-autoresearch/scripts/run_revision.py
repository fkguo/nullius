...
from hep_autoresearch.toolkit.revision import RevisionInputs, revise_one  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="revision runner v0 (compile gate + provenance table update).")
