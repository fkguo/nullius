...
from hep_autoresearch.toolkit.reproduce import ReproduceInputs, reproduce_one  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="reproduce runner v0 (toy case first).")
