...
from hep_autoresearch.toolkit.w1_ingest import IngestInputs, ingest_one  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="W1 ingestion runner (deterministic, v0).")
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument("--inspire-recid", help="INSPIRE literature recid, e.g. 3112995")
    ...
    if result.get("errors"):
        print("W1_ingest: completed with warnings/errors:")
