...
This project is early-stage and evolves quickly. This file is a lightweight, human-readable index so that version strings recorded in artifacts (e.g., `manifest.json`) can be traced back to concrete deltas.
