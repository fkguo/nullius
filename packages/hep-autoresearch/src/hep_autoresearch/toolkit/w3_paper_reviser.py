...
from .w3_paper_reviser_evidence import run_step_d_evidence_synthesis
from .w3_paper_reviser_utils import (
    _diff_text,
    _fs_token,
...
def paper_reviser_one(
    ...
    *,
    ...
    """
    W3_paper_reviser: evidence-first, resumable A-E workflow around the external paper-reviser skill.
    ...
    wf_evidence_path = Path(__file__).with_name("w3_paper_reviser_evidence.py").resolve()
    wf_utils_path = Path(__file__).with_name("w3_paper_reviser_utils.py").resolve()
    ...
    manifest: dict[str, Any] = {
        ...
        "command": "hepar run --workflow-id W3_paper_reviser",
    ...
    summary: dict[str, Any] = {
        "schema_version": 1,
        "created_at": created_at,
        "definitions": {"workflow": "W3_paper_reviser"},
        "stats": {
