...
Important: this package repo is the **development home** of `hep-autoresearch`, not the research-project root you operate on day to day. Run `hep-autoresearch init` inside your own research project directory to scaffold `PROJECT_CHARTER.md`, `PROJECT_MAP.md`, `RESEARCH_PLAN.md`, `PREWORK.md`, `Draft_Derivation.md`, `.autoresearch/`, `docs/`, `knowledge_base/`, and `specs/`.
