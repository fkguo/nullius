...
- Transitional Pipeline A commands that remain here for now: `hep-autoresearch doctor|bridge`, plus residual non-computation `hep-autoresearch run --workflow-id ...` workflows
