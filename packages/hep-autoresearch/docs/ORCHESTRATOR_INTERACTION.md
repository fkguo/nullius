...
- no live internal support launcher residue remains; retired-public maintainer helpers such as `branch`, `run-card`, and `method-design` remain on the full parser only and are not installable public-shell truth
