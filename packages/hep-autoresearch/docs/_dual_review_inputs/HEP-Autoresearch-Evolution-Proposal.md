...
项目中引用 recid-3109742 的文件: 30 个 (注: v3.6 的 125 统计包含 artifacts 等运行产物; v3.7 起收窄口径至项目源文件，排除 artifacts/, team/, paper/, references/, .hep/, .autopilot/, .git/, __pycache__)
...
rg -l 'recid-3109742' --glob '!{artifacts,team,paper,references,.hep,.autopilot,.git,__pycache__}/**' | wc -l
```
