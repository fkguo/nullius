export const NULLIUS_PUBLIC_COMMAND_INVENTORY = [
  ...
  { command: 'decision', usage: 'nullius decision record "<text>" [--by <who>] [--resolves <id>] | nullius decision pending "<text>" [--by <who>] | nullius decision list [--json] | nullius decision land [--json]' },
