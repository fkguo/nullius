export const NULLIUS_PUBLIC_COMMAND_INVENTORY = [
  ...
  { command: 'decision', usage: 'nullius decision record "<text>" [--by <who>] [--resolves <id>] [--relates <id>] | nullius decision pending "<text>" [--by <who>] [--relates <id>] | nullius decision list [--json] | nullius decision land [--json]' },
  { command: 'status', usage: 'nullius status [--json]' },
  { command: 'trace', usage: 'nullius trace stamp <run_dir> [--dep name=path] [--event-id <ulid>] | nullius trace supersede <old_run_id> --by <new_run_id> --reason "..." [--scope <name>] | nullius trace void <run_id> --reason "..." [--scope <name>] | nullius trace reinstate <run_id> --reason "..."' },
