...
- `node.set_grounding_audit` grounding-audit recording, `node.revise_card` optimistic whole-card revision, and `node.rewrite_provenance` scoped provenance correction
