...
class TestScaffoldContract(unittest.TestCase):
    ...
    def test_research_notebook_template_is_logic_first_not_date_first(self) -> None:
        ...
        self.assertIn("## Physical Question Map", template)
        self.assertIn("## Literature Evidence", template)
        self.assertIn("## Conventions and Normalizations", template)
        self.assertIn("## Derivation Threads", template)
