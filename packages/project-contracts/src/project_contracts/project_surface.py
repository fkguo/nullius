...
MAIN_RESEARCH_REPORT_TEMPLATE = "reports/main_research_report_template.md"
...
SCAFFOLD_TEMPLATE_MAP = {
    ...
    MAIN_RESEARCH_REPORT_TEMPLATE: "main_research_report_template.md",
    PROJECT_GITIGNORE: "project_gitignore.txt",
    "AGENTS.md": "AGENTS.md",
}
