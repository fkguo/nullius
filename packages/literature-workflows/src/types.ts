...
export const LiteratureSaturationContractSchema = z.object({
  ...
  candidate_disposition_ledger_required: z.literal(true),
  core_paper_references_required: z.literal(true),
  core_paper_citations_required: z.literal(true),
  bibliography_reconciliation_required: z.literal(true),
  stable_identity_resolution_required: z.literal(true),
  unresolved_candidates_are_coverage_debt: z.literal(true),
  method_family_audit_required: z.literal(true),
  method_description_evidence_required: z.literal(true),
  bounded_bibliography_traversal_required: z.literal(true),
