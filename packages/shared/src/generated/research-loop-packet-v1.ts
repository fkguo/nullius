 ...
 */
export type TaskKind = 'literature' | 'idea' | 'compute' | 'evidence_search' | 'finding' | 'draft_update' | 'review';
/**
 * This interface was referenced by `ResearchLoopPacketV1`'s JSON-Schema
 * via the `definition` "handoff_kind".
 */
export type HandoffKind = 'compute' | 'feedback' | 'literature' | 'review' | 'writing';
/**
 * This interface was referenced by `ResearchLoopPacketV1`'s JSON-Schema
 ...
 */
export type TaskStatus = 'pending' | 'active' | 'completed' | 'blocked' | 'cancelled';
/**
 * This interface was referenced by `ResearchLoopPacketV1`'s JSON-Schema
 ...
 */
export type InterventionKind = 'pause' | 'resume' | 'redirect' | 'inject_task' | 'approve' | 'cancel' | 'cascade_stop';
