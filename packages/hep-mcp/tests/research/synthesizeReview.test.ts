        ...
        key_equations: [
          {
            ...
            provenance: { backend: 'mcp_sampling', status: 'applied', used_fallback: false, reason_code: 'central_claim_equation' },
            reference_count: 2,
            section: 'Results',
          },
          {
            ...
            provenance: { backend: 'mcp_sampling', status: 'applied', used_fallback: false, reason_code: 'supporting_definition' },
            reference_count: 4,
            section: 'Setup',
          },
        ],
