...
describe('groupByMethodology', () => {
  it('keeps public method groups generic while surfacing manual-review-only evidence in descriptions', () => {
    ...
    expect(groups.some(group => group.description.includes('manual-review-only bucket'))).toBe(true);
