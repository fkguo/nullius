...
| `@autoresearch/hep-mcp` | First mature provider family: INSPIRE-HEP + evidence-first HEP workflows (`hep_*`, `zotero_*`, `pdg_*`) (67 std / 94) | Active |
...
Tool counts: **67 tools in `standard` mode** (default, compact surface) and **94 tools in `full` mode** (adds advanced tools).
...
| `full` | 94 | `standard` + advanced tools |
