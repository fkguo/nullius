...
Tool counts: **66 tools in `standard` mode** (default, compact surface) and **83 tools in `full` mode** (adds advanced tools).

### Tool Exposure Modes

| Mode | Tools | Description |
|------|-------|-------------|
| `standard` | 66 | Default: compact, recommended |
| `full` | 83 | `standard` + advanced tools |
