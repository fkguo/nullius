...
│  │ (71 std / 83)   │  │  (FS+Memory)    │  │ (Rate Limit)│ │
│  └─────────────────┘  └─────────────────┘  └──────┬──────┘ │
└───────────────┬───────────────────────┬──────────┼────────┘
                │                       │          │ HTTPS APIs
                │ local FS              │ localhost│
...
Tool counts: **71 tools in `standard` mode** (default, compact surface) and **83 tools in `full` mode** (adds advanced/heavy tools like Style Corpus).
...
| `full` | 83 | `standard` + advanced/heavy tools |
