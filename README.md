...
| `@autoresearch/hep-mcp` | First mature provider family: INSPIRE-HEP + evidence-first HEP workflows (`hep_*`, `zotero_*`, `pdg_*`) (67 std / 86) | Active |
...
Tool counts: **67 tools in `standard` mode** (default, compact surface) and **86 tools in `full` mode** (adds advanced tools).
...
| `full` | 86 | `standard` + advanced tools |
