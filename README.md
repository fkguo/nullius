...
| `@autoresearch/hep-mcp` | First mature provider family: INSPIRE-HEP + evidence-first HEP workflows (`hep_*`, `zotero_*`, `pdg_*`) (73 std / 102) | Active |
...
| `full` | 102 | `standard` + advanced tools |
