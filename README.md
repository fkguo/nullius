...
Tool counts: **74 tools in `standard` mode** (default, compact surface) and **86 tools in `full` mode** (adds advanced/heavy tools like Style Corpus).

### Tool Exposure Modes

| Mode | Tools | Description |
|------|-------|-------------|
| `standard` | 74 | Default: compact, recommended |
| `full` | 86 | `standard` + advanced/heavy tools |
