...
| `@autoresearch/hep-mcp` | First mature provider family: INSPIRE-HEP + evidence-first HEP workflows (`hep_*`, `zotero_*`, `pdg_*`) (67 std / 93) | Active |
...
Tool counts: **67 tools in `standard` mode** (default, compact surface) and **93 tools in `full` mode** (adds advanced tools).
...
| `full` | 93 | `standard` + advanced tools |
