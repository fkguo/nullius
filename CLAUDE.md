...
This project is indexed by GitNexus as **autoresearch-lab** (12129 symbols, 26919 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
