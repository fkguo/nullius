...
This project is indexed by GitNexus as **autoresearch-lab-evo03-writing-review-substrate** (8035 symbols, 21668 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-evo03-writing-review-substrate/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-evo03-writing-review-substrate/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-evo03-writing-review-substrate/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-evo03-writing-review-substrate/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-evo03-writing-review-substrate/process/{name}` | Step-by-step execution trace |
