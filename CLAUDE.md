...
This project is indexed by GitNexus as **autoresearch-lab** (10018 symbols, 23449 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
