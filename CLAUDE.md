...
This project is indexed by GitNexus as **autoresearch-lab-new-comp-02-impl** (7874 symbols, 21209 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-new-comp-02-impl/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-new-comp-02-impl/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-new-comp-02-impl/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-new-comp-02-impl/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-new-comp-02-impl/process/{name}` | Step-by-step execution trace |
