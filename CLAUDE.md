...
This project is indexed by GitNexus as **autoresearch-lab** (11813 symbols, 26087 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
