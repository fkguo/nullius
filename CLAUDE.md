...
This project is indexed by GitNexus as **autoresearch-lab** (12976 symbols, 29016 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
