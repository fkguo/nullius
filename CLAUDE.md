...
This project is indexed by GitNexus as **autoresearch-lab** (12084 symbols, 26815 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
