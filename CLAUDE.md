...
This project is indexed by GitNexus as **autoresearch-lab** (10131 symbols, 23810 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
