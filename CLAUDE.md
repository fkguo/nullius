...
This project is indexed by GitNexus as **autoresearch-lab** (11894 symbols, 26296 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
