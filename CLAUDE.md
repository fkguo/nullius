...
This project is indexed by GitNexus as **autoresearch-lab** (11908 symbols, 26334 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
