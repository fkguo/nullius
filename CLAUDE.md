...
This project is indexed by GitNexus as **autoresearch-lab** (12065 symbols, 26781 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
