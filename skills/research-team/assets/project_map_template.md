...
- Optional draft-cycle entry (agent or manual; materializes the optional draft pointer after it runs): `bash "${SKILL_DIR:-${CODEX_HOME:-$HOME/.codex}/skills/research-team}/scripts/bin/run_draft_cycle.sh" --tag 20260502T023000Z-d0-draft-r1 --tex main.tex --bib refs.bib --out-dir team`
