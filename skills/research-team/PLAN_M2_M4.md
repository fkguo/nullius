# research-team vNext — M2/M3/M4 detailed plan (draft)

Status: DRAFT (awaiting reviewer convergence + user approval)

Last updated: 2026-01-29

This document expands `ROADMAP.md` into an execution plan with:
