...
| Problem Framing Snapshot (PREWORK.md) | [SKILL.md](SKILL.md), [RUNBOOK.md](RUNBOOK.md) | [check_problem_framing_snapshot.py](scripts/gates/check_problem_framing_snapshot.py) | [smoke_test_problem_framing_snapshot_gate.sh](scripts/dev/smoke/smoke_test_problem_framing_snapshot_gate.sh) |
