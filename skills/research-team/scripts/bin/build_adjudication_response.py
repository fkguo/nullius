...
def main() -> int:
    ...
    lines.append("`Rewritten sections:` takes quoted notebook headings separated by `;`")
    lines.append("(each rewritten section carries a fresh `<!-- written-against: <commit> -->`")
    lines.append("stamp) or `none`.")
    lines.append("")
