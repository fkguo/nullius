...
def _ensure_project_map_exists(project_root: Path) -> Path:
    ...
    lines.append("")
    lines.append("- Latest pointers: [team/LATEST.md](team/LATEST.md)")
    lines.append("- Latest team cycle: [team/LATEST_TEAM.md](team/LATEST_TEAM.md)")
    lines.append("- Latest draft cycle: [team/LATEST_DRAFT.md](team/LATEST_DRAFT.md)")
    lines.append("- Latest artifacts: [artifacts/LATEST.md](artifacts/LATEST.md)")
    lines.append("- Trajectory index: [team/trajectory_index.json](team/trajectory_index.json)")
    lines.append("")
    lines.append("---")
    lines.append("")
