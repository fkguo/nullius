...
bash "${BIN_DIR}/scaffold_research_workflow.sh" --root "${proj}" --project "SmokePrune" --profile "mixed" >/dev/null 2>&1
...
dry_archive="${proj}/team/migrations/prune_smoke_dry"
...
apply_archive="${proj}/team/migrations/prune_smoke_apply"
