...
class LiteratureSaturationContract(BaseModel):
    ...
    candidate_disposition_ledger_required: Literal[True]
    core_paper_references_required: Literal[True]
    core_paper_citations_required: Literal[True]
    bibliography_reconciliation_required: Literal[True]
    stable_identity_resolution_required: Literal[True]
    unresolved_candidates_are_coverage_debt: Literal[True]
    method_family_audit_required: Literal[True]
    method_description_evidence_required: Literal[True]
    bounded_bibliography_traversal_required: Literal[True]
