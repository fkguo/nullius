...
```json
{
  "domain": "string (组件名: hep-mcp | idea-core | hepar | skill)",
  "code": "string (错误码)",
  "message": "string (人类可读)",
  "retryable": "boolean",
  "run_id": "string | null",
...
```json
{
  "component": "hep-mcp | hepar | idea-core",
...
**规则**: `idea-core/contracts/idea-generator-snapshot/` 中的 vendored schema 必须与 `idea-generator/schemas/` 的 SHA256 指纹一致。任何 idea-generator schema 变更必须触发 idea-core 快照校验。
...
#           比对 CONTRACT_SOURCE.json 中的 fingerprint
```
