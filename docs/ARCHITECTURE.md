...
| Agent project harness skill | `research-harness` | Market-listed thin skill for Codex / Claude Code / OpenCode to recover project truth, route execution to `autoresearch` / `research-team` / `hep-mcp`, and close out verification or handoff |
