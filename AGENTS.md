...
This project is indexed by GitNexus as **autoresearch-lab-phase2-compute-rebaseline** (7866 symbols, 21180 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-phase2-compute-rebaseline/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-phase2-compute-rebaseline/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-phase2-compute-rebaseline/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-phase2-compute-rebaseline/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-phase2-compute-rebaseline/process/{name}` | Step-by-step execution trace |
