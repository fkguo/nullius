...
This project is indexed by GitNexus as **autoresearch-lab-mcp-tooling-imports-impl** (8414 symbols, 22596 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-mcp-tooling-imports-impl/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-mcp-tooling-imports-impl/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-mcp-tooling-imports-impl/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-mcp-tooling-imports-impl/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-mcp-tooling-imports-impl/process/{name}` | Step-by-step execution trace |
