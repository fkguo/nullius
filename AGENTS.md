...
This project is indexed by GitNexus as **autoresearch-lab-evo13-batch1** (10288 symbols, 24420 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
