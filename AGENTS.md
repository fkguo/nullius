...
This project is indexed by GitNexus as **autoresearch-lab-retro-closeout-rereview** (8421 symbols, 22618 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-retro-closeout-rereview/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-retro-closeout-rereview/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-retro-closeout-rereview/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-retro-closeout-rereview/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-retro-closeout-rereview/process/{name}` | Step-by-step execution trace |
