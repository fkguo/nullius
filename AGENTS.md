...
This project is indexed by GitNexus as **autoresearch-lab** (11901 symbols, 27524 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
