...
This project is indexed by GitNexus as **autoresearch-lab** (9850 symbols, 23020 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
