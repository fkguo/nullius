...
This project is indexed by GitNexus as **autoresearch-lab** (9828 symbols, 22877 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
