...
This project is indexed by GitNexus as **autoresearch-lab** (9784 symbols, 22826 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
