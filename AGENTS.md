...
This project is indexed by GitNexus as **autoresearch-lab** (11749 symbols, 25961 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
