...
This project is indexed by GitNexus as **autoresearch-lab-new05a-stage3-authority-repair** (8433 symbols, 22652 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-new05a-stage3-authority-repair/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-new05a-stage3-authority-repair/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-new05a-stage3-authority-repair/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-new05a-stage3-authority-repair/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-new05a-stage3-authority-repair/process/{name}` | Step-by-step execution trace |
