...
This project is indexed by GitNexus as **autoresearch-lab-new05a-shared-boundary-rereview** (8484 symbols, 22858 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-new05a-shared-boundary-rereview/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-new05a-shared-boundary-rereview/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-new05a-shared-boundary-rereview/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-new05a-shared-boundary-rereview/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-new05a-shared-boundary-rereview/process/{name}` | Step-by-step execution trace |
