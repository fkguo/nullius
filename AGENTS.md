...
This project is indexed by GitNexus as **autoresearch-lab** (12765 symbols, 28767 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
