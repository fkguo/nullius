...
This project is indexed by GitNexus as **autoresearch-lab** (11744 symbols, 25935 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
