...
This project is indexed by GitNexus as **autoresearch-lab** (9976 symbols, 23285 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
