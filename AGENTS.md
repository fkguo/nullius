...
This project is indexed by GitNexus as **autoresearch-lab** (9781 symbols, 22813 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
