...
This project is indexed by GitNexus as **autoresearch-lab-batch16-sem11-sem12** (7814 symbols, 21035 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-batch16-sem11-sem12/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-batch16-sem11-sem12/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-batch16-sem11-sem12/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-batch16-sem11-sem12/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-batch16-sem11-sem12/process/{name}` | Step-by-step execution trace |
