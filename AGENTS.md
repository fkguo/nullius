...
This project is indexed by GitNexus as **autoresearch-lab-approval-cluster-rebaseline** (11349 symbols, 27012 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/autoresearch-lab-approval-cluster-rebaseline/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/autoresearch-lab-approval-cluster-rebaseline/context` | Codebase overview, check index freshness |
| `gitnexus://repo/autoresearch-lab-approval-cluster-rebaseline/clusters` | All functional areas |
| `gitnexus://repo/autoresearch-lab-approval-cluster-rebaseline/processes` | All execution flows |
| `gitnexus://repo/autoresearch-lab-approval-cluster-rebaseline/process/{name}` | Step-by-step execution trace |
